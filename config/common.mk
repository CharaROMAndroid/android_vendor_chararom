...
$(call inherit-product-if-exists, vendor/lineage/config/chararom.mk)
...
PRODUCT_COPY_FILES += \
    vendor/lineage/prebuilt/google/etc/sysconfig/pixel_2016_exclusive.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/pixel_2016_exclusive.xml
...
PRODUCT_EXTRA_RECOVERY_KEYS += \
    vendor/lineage/build/target/product/security/lineage #Use CharaROM's cert
