...
CHARAROM_STATUS := Completionary-Stable
...
LINEAGE_VERSION_SUFFIX := $(LINEAGE_BUILD_DATE)-$(LINEAGE_BUILDTYPE)-Android$(ANDROID_VERSION)-$(CHARAROM_STATUS)-$(LINEAGE_BUILD)

# Internal version (full)
LINEAGE_VERSION := CharaROM-v$(CHARAROM_VERSION)-$(LINEAGE_VERSION_SUFFIX)
...
PRODUCT_PRODUCT_PROPERTIES += \
    ...
    ro.android.device=$(LINEAGE_BUILD)